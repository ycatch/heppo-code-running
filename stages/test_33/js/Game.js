...
BasicGame.Game = function (game) {
    ...
    this._enemy = null;
    this._enemyRadarBall = null;
    this._enemyRadarBallID = null;
...
BasicGame.Game.prototype = {
    ...
    create: function () {
        ...
        // ** The player settings **
        this._player = this.add.sprite(500, this.world.height - 200, 'bot');
        ...
        // ** The Enemy settings **
        this._enemy = this.add.sprite(500, this.world.height - 600, 'enemy');
        this.physics.enable(this._enemy);
		this._enemy.body.bounce.y = 0.15;
		this._enemy.body.gravity.y = 600;
		this._enemy.body.collideWorldBounds = true;

        // ** radar for check Energy-Ball **
        this._radarBall = this.add.sprite(481, this.world.height - 280, 'radarBall');
        this.physics.enable(this._radarBall);
        this._enemyRadarBall = this.add.sprite(481, this.world.height - 600, 'radarBall');
        this.physics.enable(this._enemyRadarBall);

        // ** FPS & score
		this.time.advancedTiming = true;
		this._scoreText = this.add.text(16, 16, '走行距離:0m', { font: '32px  pixelmplus10regular', fill: '#000' });
        ...
        this._enemy.animations.add('right', [0, 1, 2, 3,], 10, true);
